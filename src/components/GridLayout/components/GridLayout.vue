...
const updateHeight = () => {
    ...
    mergedStyle.value = {
        height: `${containerHeight}px`,
        backgroundImage: `repeating-linear-gradient(90deg,transparent 0px, transparent ${state.colWidth}px, #eee ${state.colWidth}px, #eee ${state.colWidth + props.marginLeft
            }px, transparent ${state.colWidth + props.marginLeft}px),
      repeating-linear-gradient(180deg, transparent 0px, transparent ${props.rowHeight}px, #eee ${props.rowHeight + props.marginTop}px,transparent ${props.rowHeight + props.marginTop
            }px)`
    };
};
